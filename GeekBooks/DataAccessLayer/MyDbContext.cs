...
namespace GeekBooks.DataAccessLayer
{
    ...
    public class MyDbInitializer : DropCreateDatabaseIfModelChanges<MyDbContext>
    {
        protected override void Seed(MyDbContext context)
        {
            ...
            context.Products.Add(new Product { ProductID = 6, AuthID = 7, CoverUrl = "https://prodimage.images-bn.com/pimages/9780451524935_p0_v2_s192x300.jpg", Genre = "Science Fiction", Price = 8.99, ProductName = "1984", Publisher = "Penguin Publising Group", Stock = 0, Synopsis = "Winston Smith toes the Party line, rewriting history to satisfy the demands of the Ministry of Truth. With each lie he writes, Winston grows to hate the Party that seeks power for its own sake and persecutes those who dare to commit thoughtcrimes. But as he starts to think for himself, Winston can’t escape the fact that Big Brother is always watching..." });
            ...
            context.Products.Add(new Product { ProductID = 11, AuthID = 9, CoverUrl = "https://prodimage.images-bn.com/pimages/9780345339706_p0_v1_s192x300.jpg", Genre = "Fantasy", Price = 8.99, ProductName = "The Fellowship of the Ring", Publisher = "Random House Publishing Group", Stock = 50, Synopsis = "The dark, fearsome Ringwraiths are searching for a Hobbit. Frodo Baggins knows that they are seeking him and the Ring he bears—the Ring of Power that will enable evil Sauron to destroy all that is good in Middle-earth. Now it is up to Frodo and his faithful servant, Sam, with a small band of companions, to carry the Ring to the one place it can be destroyed: Mount Doom, in the very center of Sauron’s realm." });
            context.Products.Add(new Product { ProductID = 12, AuthID = 9, CoverUrl = "https://prodimage.images-bn.com/pimages/9780345339713_p0_v1_s192x300.jpg", Genre = "Fantasy", Price = 18.99, ProductName = "The Two Towers", Publisher = "Random House Publishing Group", Stock = 50, Synopsis = "The Fellowship is scattered. Some are bracing hopelessly for war against the ancient evil of Sauron. Some are contending with the treachery of the wizard Saruman. Only Frodo and Sam are left to take the accursed One Ring, ruler of all the Rings of Power, to be destroyed in Mordor, the dark realm where Sauron is supreme. Their guide is Gollum, deceitful and lust-filled, slave to the corruption of the Ring." });
            context.Products.Add(new Product { ProductID = 13, AuthID = 9, CoverUrl = "https://prodimage.images-bn.com/pimages/9780345339737_p0_v1_s192x300.jpg", Genre = "Fantasy", Price = 18.99, ProductName = "The Return of the King", Publisher = "Random House Publishing Group", Stock = 50, Synopsis = "While the evil might of the Dark Lord Sauron swarms out to conquer all Middle-earth, Frodo and Sam struggle deep into Mordor, seat of Sauron’s power. To defeat the Dark Lord, the One Ring, ruler of all the accursed Rings of Power, must be destroyed in the fires of Mount Doom. But the way is impossibly hard, and Frodo is weakening. Weighed down by the compulsion of the Ring, he begins finally to despair." });
            context.Products.Add(new Product { ProductID = 14, AuthID = 2, CoverUrl = "https://prodimage.images-bn.com/pimages/9781429963947_p0_v2_s192x300.jpg", Genre = "Science Fiction", Price = 7.99, ProductName = "Speaker for the Dead", Publisher = "Tom Doherty Associates", Stock = 50, Synopsis = "In the aftermath of his terrible war, Ender Wiggin disappeared, and a powerful voice arose: The Speaker for the Dead, who told the true story of the Bugger War. Now, long years later, a second alien race has been discovered, but again the aliens' ways are strange and frightening...again, humans die. And it is only the Speaker for the Dead, who is also Ender Wiggin the Xenocide, who has the courage to confront the mystery...and the truth." });
            context.Products.Add(new Product { ProductID = 15, AuthID = 2, CoverUrl = "https://prodimage.images-bn.com/pimages/9781429963961_p0_v4_s192x300.jpg", Genre = "Science Fiction", Price = 8.99, ProductName = "Xenocide", Publisher = "Tom Doherty Associates", Stock = 50, Synopsis = "The war for survival of the planet Lusitania will be fought in the heart of a child named Gloriously Bright. On Lusitania, Ender found a world where humans and pequininos and the Hive Queen could all live together; where three very different intelligent species could find common ground at last. Or so he thought. Lusitania also harbors the descolada, a virus that kills all humans it infects, but which the pequininos require in order to become adults. The Starways Congress so fears the effects of the descolada, should it escape from Lusitania, that they have ordered the destruction of the entire planet, and all who live there.The Fleet is on its way, a second xenocide seems inevitable." });

            context.Products.Add(new Product { ProductID = 16, AuthID = 7, CoverUrl = "https://prodimage.images-bn.com/pimages/9780451526342_p0_v2_s192x300.jpg", Genre = "Fiction", Price = 8.99, ProductName = "Animal Farm", Publisher = "Penguin Publising Group", Stock = 0, Synopsis = "A farm is taken over by its overworked, mistreated animals. With flaming idealism and stirring slogans, they set out to create a paradise of progress, justice, and equality. Thus the stage is set for one of the most telling satiric fables ever penned—a razor-edged fairy tale for grown-ups that records the evolution from revolution against tyranny to a totalitarianism just as terrible."});
            context.Products.Add(new Product { ProductID = 17, AuthID = 10, CoverUrl = "https://prodimage.images-bn.com/pimages/9780316198363_p0_v2_s192x300.jpg", Genre = "Fantasy", Price = 25.99, ProductName = "Sprit's End", Publisher = "Orbit", Stock = 50, Synopsis = "First rule of thievery: don't be a hero. When Eli broke the rules and saved the Council Kingdoms, he thought he knew the price, but resuming his place as the Shepherdess's favorite isn't as simple as bowing his head. Now that she has her darling back, Benehime is setting in motion a plan that could destroy everything she was created to protect, and even Eli's charm might not be enough to stop her. " });
            context.Products.Add(new Product { ProductID = 18, AuthID = 10, CoverUrl = "https://prodimage.images-bn.com/pimages/9780316193573_p0_v1_s192x300.jpg", Genre = "Fantasy", Price = 25.99, ProductName = "The Legend of Eli Monpress", Publisher = "Orbit", Stock = 50, Synopsis = "Eli Monpress is talented. He's charming. And he's a thief. But not just any thief.He's the greatest thief of the age - and he's also a wizard.And with the help of his partners - a swordsman with the most powerful magic sword in the world but no magical ability of his own, and a demonseed who can step through shadows and punch through walls - he's going to put his plan into effect. The first step is to increase the size of the bounty on his head, so he'll need to steal some big things. But he'll start small for now.He'll just steal something that no one will miss - at least for a while. Like a king." });
